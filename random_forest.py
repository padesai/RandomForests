...
class RandomForest(object):
    ...
    def fitting(self):
        ...
        for i in range(0,self.num_trees):
            ...
            self.decision_trees[i] = decisiontree.learn(self.bootstraps_datasets[i],self.bootstraps_labels[i])
            ...
            if len(counts) == 0:
                ...
                for i in range(len(self.bootstraps_datasets)):
                    ...
                    if record in dataset:
                        train_tree = self.decision_trees[i]
                        result = train_tree.classify(record)
